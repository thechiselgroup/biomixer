...
public class GraphSvgDisplayInteractionOutputTest extends
    ...
    @Ignore("TODO: need to add handlers manually?")
    @Test
    public void mousingOverNodeCausesHighlighting() {
        addNode(ID1, LABEL1, TYPE);
        underTest.onNodeMouseOver(ID1, 10, 10);
        assertSvgRootElementEqualsFile("highlightedNode", underTest.asSvg());
    }

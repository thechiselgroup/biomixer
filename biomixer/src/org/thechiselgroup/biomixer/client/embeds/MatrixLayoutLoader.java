...
import org.thechiselgroup.biomixer.client.services.matrix.MatrixLayoutServiceAsync;
...
/**
 * Calls the Javascript implementation of the matrix layout
 * 
 * @author elenavoy
 */
public class MatrixLayoutLoader implements EmbeddedViewLoader {

    @Inject
    private ErrorHandler errorHandler;

    public static final String EMBED_MODE = "matrix_layout";
    ...
    public void loadView(WindowLocation windowLocation, String embedMode,
        ...
        matrixLayoutService
                .getMatrixLayoutAsJson(new ErrorHandlingAsyncCallback<String>(
                        errorHandler) {

 ...
 * 
 * Could be useful later, when we want to load multiple target ontologies,
 * rather than getting the neighbourhood of an ontology as in the
 * OntologyMappingNeighbourhood version of this.
 * 
 * @author everbeek
 * 
 */

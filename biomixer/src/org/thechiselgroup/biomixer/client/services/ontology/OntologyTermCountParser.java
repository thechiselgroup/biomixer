...
public class OntologyTermCountParser extends AbstractXMLResultParser {

    @Inject
    public OntologyTermCountParser(DocumentProcessor documentProcessor) {
        super(documentProcessor);
    }

    public String parse(String xmlText) throws Exception {
        return getText(parseDocument(xmlText),
                "//success/data/page/numResultsTotal/text()");
    }

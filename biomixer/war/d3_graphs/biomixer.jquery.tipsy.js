...
//                });
                ...
                actualWidth = $tip.find('.tipsy-inner').children().first().width();
                actualHeight = $tip.find('.tipsy-inner').children().first().height();
...
//                        tp.left = pos.left + pos.width / 2 - 15;
                    	tp.left = pos.left + pos.width + this.options.offset;
                    } else {
//                        tp.left = pos.left + pos.width / 2 - actualWidth + 15;
                    	tp.left = pos.left - actualWidth - this.options.offset;
                    }
                }

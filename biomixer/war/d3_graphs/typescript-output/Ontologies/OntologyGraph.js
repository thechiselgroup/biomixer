...
define(["require", "exports", "../Utils", "../FetchFromApi", "../GraphView", "./NodeAreaToggleWidget", "Utils", "FetchFromApi", "GraphView", "ExpansionSets", "LayoutProvider", "Ontologies/NodeAreaToggleWidget"], function (require, exports, Utils, Fetcher, GraphView, NodeAreaToggleWidget) {
    var Node = (function (_super) {
        ...
        function Node() {
            _super.call(this);
            this.mapped_classes_to_central_node = 0; // = 0;
            this.metricsFetched = undefined;
            // These come from details REST call
            this.numberOfClasses = 0; // = numClasses;
        }
    ...
    var OntologyGraph = (function () {
        ...
        OntologyGraph.prototype.getOntologySortFunction = function () {
            var outerThis = this;
            var sortFunc;
        ...
        function OntologyMappingCallback(graph, url, centralOntologyAcronym, expansionSet) {
            ...
            this.callback = function (mappingData, textStatus, jqXHR) {
                ...
                $.each(_this.graph.sortedAcronymsByMappingCount, function (index, sortedAcronym) {
                    ...
                    if (ontologyNode.rawAcronym !== _this.centralOntologyAcronym) {
                ...
                //        this.graph.sortOntologies();
                var sortFunc = _this.graph.getOntologySortFunction();
                _this.graph.sortedAcronymsByMappingCount = _this.graph.sortedAcronymsByMappingCount.sort(sortFunc);
            ...
            this.callback = function (metricDataRaw, textStatus, jqXHR) {
                ...
                if (jqXHR != null) {
                    if (metricDataRaw.errors != null) {
                        // We had an error. Handle it.
                        //                remove this from the dataset, it's no good!
                        _this.node.metricsFetched = false;
                        return;
                    }
                }
                ...
                _this.node.metricsFetched = true;

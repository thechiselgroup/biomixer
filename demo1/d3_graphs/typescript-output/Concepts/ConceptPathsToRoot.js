        ...
        function ConceptPathsToRoot(centralOntologyAcronym, centralConceptUri, softNodeCap) {
            ...
            this.updateArcLineFunc = function (linkData, ignoreOffset) {
                ...
                if (ignoreOffset) {
                    ...
                    offset = 10;
                } else if (linkData.relationType === _this.conceptGraph.relationLabelConstants.inheritance || linkData.relationType === _this.conceptGraph.relationLabelConstants.mapping) {
                    offset = 0;
                } else {

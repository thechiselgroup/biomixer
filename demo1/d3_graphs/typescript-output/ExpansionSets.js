...
define(["require", "exports", "./GraphModifierCommand", "UndoRedo/UndoRedoManager", "GraphView", "GraphModifierCommand"], function(require, exports, GraphModifierCommand) {
    ...
    */
    var ExpansionSet = (function () {
        ...
        */
        function ExpansionSet(id, parentNode, graph, undoRedoBoss, expansionType) {
            this.id = id;
            ...
            */
            ...
            this.graphModifier = new GraphModifierCommand.GraphAddNodesCommand(graph, this);
        ...
        ExpansionSet.prototype.addIncludedNodeUri = function (incomingNodeId) {
        ...
        ExpansionSet.prototype.getNumberOfNodesAssociatedWithExpansion = function () {

    ...
    var OntologyMappingOverview = (function (_super) {
        ...
        */
        ...
        OntologyMappingOverview.prototype.populateNewGraphEdges = function (linksData) {
            ...
            // Link stuff first
            var links = this.vis.select("#link_container").selectAll(GraphView.BaseGraphView.linkSvgClass).data(linksData, function (d) {
        ...
        OntologyMappingOverview.prototype.populateNewGraphNodes = function (nodesData) {
            ...
            // Node stuff now
            var nodes = this.vis.select("#node_container").selectAll("g.node_g").data(nodesData, function (d) {
                return d.rawAcronym;
            });
        ...
        */
        ...
        OntologyMappingOverview.prototype.removeGraphPopulation = function (data) {
            ...
            var nodes = this.vis.selectAll("g.node_g").data(this.ontologyGraph.graphD3Format.nodes, function (d) {
                return d.rawAcronym;
            });
            var links = this.vis.selectAll(GraphView.BaseGraphView.linkSvgClass).data(this.ontologyGraph.graphD3Format.links, function (d) {
                return d.source.rawAcronym + "-to-" + d.target.rawAcronym;
            });

...
define(["require", "exports", "../Utils", "../FetchFromApi", "../Menu", "../GraphView", "../ExpansionSets", "../TipsyToolTipsOnClick", "../CompositeExpansionDeletionSet", "./ConceptGraph", "./CherryPickConceptFilter", "./OntologyConceptFilter", "./ExpansionSetFilter", "./ConceptEdgeTypeFilter", "./ConceptFilterSliders", "./ConceptLayouts", "./GraphImporterExporter", "./NodeDeleterWidgets", "JQueryExtension", "Utils", "Menu", "GraphView", "ExpansionSets", "FetchFromApi", "TipsyToolTips", "TipsyToolTipsOnClick", "UndoRedo/UndoRedoManager", "CompositeExpansionDeletionSet", "Concepts/ConceptGraph", "Concepts/ConceptFilterSliders", "Concepts/CherryPickConceptFilter", "Concepts/OntologyConceptFilter", "Concepts/ExpansionSetFilter", "Concepts/ConceptNodeFilterWidget", "Concepts/ConceptEdgeTypeFilter", "Concepts/ConceptFilterSliders", "Concepts/ConceptLayouts", "Concepts/GraphImporterExporter", "Concepts/NodeDeleterWidgets", "Concepts/ConceptRenderScaler"], function(require, exports, Utils, Fetch, Menu, GraphView, ExpansionSets, TipsyToolTipsOnClick, CompositeExpansionDeletionSet, ConceptGraph, CherryPickConceptFilter, OntologyConceptFilter, ExpansionSetFilter, ConceptEdgeTypeFilter, ConceptFilterSliders, ConceptLayouts, ImporterExporter, NodeDeleter) {
    var ConceptPathsToRoot = (function (_super) {
        __extends(ConceptPathsToRoot, _super);
        function ConceptPathsToRoot(centralOntologyAcronym, centralConceptUri, softNodeCap) {
            var _this = this;
            _super.call(this);
            ...
            */
            ...
            $("#visualization_selector").change(function () {
                console.log("Changing visualization mode.");
                var selected = $("#visualization_selector option:selected").text();
        ...
        ConceptPathsToRoot.prototype.recomputeVisualizationOntoNode = function (nodeData) {
        ...
        */
        ConceptPathsToRoot.prototype.prepareForExpansionFromScratch = function (expId, expansionType) {
            ...
            // it could be null.
            var initSet = new CompositeExpansionDeletionSet.InitializationDeletionSet(this.conceptGraph, expId, this.undoRedoBoss, expansionType);
            this.nodeDeleter.deleteNodesForGraphInitialization(initSet);
            return initSet;
        };

        ConceptPathsToRoot.prototype.fetchInitialExpansion = function () {
        ...
        ConceptPathsToRoot.prototype.onLayoutTick = function () {
            ...
            return function () {
                ...
                if (boundNodes.length > 0) {
                    ...
                    var q = d3.geom.quadtree(_this.conceptGraph.graphD3Format.nodes, _this.visWidth(), _this.visHeight());
                    var i = 0;
                    var n = _this.conceptGraph.graphD3Format.nodes.length;
                    while (++i < n) {
                        q.visit(_this.collide(_this.conceptGraph.graphD3Format.nodes[i]));
                    }
                }
        ...
        ConceptPathsToRoot.prototype.createNodePopupTable = function (conceptRect, conceptData) {
            ...
            tBody.append($("<tr></tr>").append($("<td></td>").append($("<div></div>").text(conceptData["name"]).attr("class", "popups-Header gwt-Label avatar avatar-resourceSet GK40RFKDB dragdrop-handle"))));
            ...
            tBody.append($("<tr></tr>").append($("<td></td>").attr("align", "left").css({ "vertical-align": "top" }).append($("<div></div>").addClass("gwt-HTML").css(noWrapStyle).append($("<a></a>").attr("target", "_blank").attr("href", urlText).text("Open concept homepage in tab")))));

            var ontologyUrlText = "http://bioportal.bioontology.org/ontologies/" + conceptData["ontologyAcronym"];
            tBody.append($("<tr></tr>").append($("<td></td>").attr("align", "left").css({ "vertical-align": "top" }).append($("<div></div>").addClass("gwt-HTML").css(noWrapStyle).append($("<b></b>").text("Ontology: ")).append($("<a></a>").attr("target", "_blank").attr("href", ontologyUrlText).text(conceptData["ontologyAcronym"])))));
            ...
            $.each(jsonArgs, function (label, properties) {
                ...
                tBody.append($("<tr></tr>").append($("<td></td>").attr("align", "left").css({ "vertical-align": "top" }).append($("<div></div>").addClass("gwt-HTML").css(style).append($("<b></b>").text(label)).append($("<span></span>").text(conceptData[propertyKey])))));
            });
        ...
        */
        ...
        ConceptPathsToRoot.prototype.populateNewGraphEdges = function (linksData, temporaryEdges) {
            ...
            var enteringPolylines = enteringLinks.append("svg:polyline").attr("class", function (d) {
                return GraphView.BaseGraphView.linkSvgClassSansDot + " " + GraphView.BaseGraphView.linkClassSelectorPrefix + d.relationType + " " + outerThis.getLinkCssClass(d.relationType, d.relationSpecificToOntologyAcronym);
            }).attr("id", function (d) {
            ...
            var enteringArcMarkers = enteringLinks.append("svg:polyline").attr("class", function (d) {
        ...
        ConceptPathsToRoot.prototype.populateNewGraphNodes = function (nodesData) {
            ...
            // Basic properties
            enteringNodes.append("svg:rect").attr("id", function (d) {
        ...
        ConceptPathsToRoot.prototype.attachNodeMenu = function (enteringNodes) {
            ...
            expanderSvgs.append("svg:rect").attr("id", function (d) {
                return "node_expander_indicator_" + d.conceptUriForIds;
            ...
            return function (nodeData) {
                ...
                var innerSvg = d3.select(this).append("svg:svg").attr("id", "expanderMenu").attr("overflow", "visible").attr("y", 0).attr("x", -1 * (rectWidth / 2 + parseInt(d3.select(this).attr("x"), 0))).attr("width", rectWidth).attr("height", rectHeight * 2).style("z-index", 100).on("mouseleave", function () {
...

                 {
                    ...
                    if (hardTermExpansionCount != 0) {
                        ...
                        conceptExpandMouseUpFunc = function () {
                            ...
                            var expansionSet = new ExpansionSets.ExpansionSet(expId, nodeData, outerThis.conceptGraph, outerThis.undoRedoBoss, ConceptGraph.PathOptionConstants.termNeighborhoodConstant);
...

                 {
                    ...
                    if (hardMappingExpansionCount !== 0) {
                        ...
                        mappingExpandMouseUpFunc = function () {
                            ...
                            var expansionSet = new ExpansionSets.ExpansionSet(expId, nodeData, outerThis.conceptGraph, outerThis.undoRedoBoss, ConceptGraph.PathOptionConstants.mappingsNeighborhoodConstant);
...

                 {
                    ...
                    centralizeNodeSvg.append("svg:text").text("Refocus Node").style("font-family", "Arial, sans-serif").style("font-size", "12px").attr("x", fontXSvgPadding).attr("y", fontYSvgPadding).style("font-weight", "inherit").attr("class", GraphView.BaseGraphView.nodeLabelSvgClassSansDot + " unselectable " + " expanderMenuText").style("pointer-events", "none").attr("unselectable", "on").attr("onmousedown", "noselect").attr("onselectstart", "function(){ return false;}");
                }
        ...
        */
        ...
        ConceptPathsToRoot.prototype.sortConceptNodesCentralOntologyName = function () {
            var outerThis = this;
            return this.conceptGraph.graphD3Format.nodes.sort(function (a, b) {

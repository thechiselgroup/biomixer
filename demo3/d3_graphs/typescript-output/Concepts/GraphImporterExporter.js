    ...
    */
    ...
    var SavedGraph = (function () {
        ...
        SavedGraph.prototype.addNode = function (nodeData, graph) {
            ...
            this.n[String(nodeData.rawConceptUri)] = {
                o: nodeData.ontologyAcronym, x: nodeData.x, y: nodeData.y
            };
            if (graph.expMan.wasConceptClearedForExpansion(nodeData.rawConceptUri, ConceptGraph.PathOptionConstants.mappingsNeighborhoodConstant)) {
    ...
    var GraphImporter = (function () {
        ...
        GraphImporter.prototype.loadGraph = function () {
            ...
            for (var conceptUri in this.importData.n) {
                ...
                var nodeData = this.importData.n[conceptUri];
                if (nodeData.m) {
